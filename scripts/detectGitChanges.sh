...
for i in `cat $watch_files`;do
  ...
  curl -v -X POST https://3e59557e76bb1e832212a641cb88b09db5f69413@sonarcloud.io/api/projects/create -d "name="Harishsingh2707.$foldername."$service&project="Harishsingh2707.function."$service&organization=harishsingh2707"
done
oldIFS=${IFS}
