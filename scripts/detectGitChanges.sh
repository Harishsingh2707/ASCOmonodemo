...
curl -v -X POST https://97f1c09de1c29177f915da607c5920afd9fa5aa7@sonarcloud.io/api/alm_integration/provision_monorepo_projects -d '{"projects":[{"projectKey":"'"Cloudtechner.$service"'","projectName":"'"Cloudtechner.$service"'","installationKey":"Harishsingh2707/ASCOmonodemo|416288470"}],"organization":"harishsingh2707"}'
#done
oldIFS=${IFS}
